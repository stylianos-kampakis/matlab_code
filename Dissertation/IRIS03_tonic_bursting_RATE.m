...
options=izknet_optionset('Number_of_inputs',2,'ms',20,'Std_constant',2.5 ...
    ,'Voltage_sent',500,'Amplifier',500,...
    'SelectionFcn',@selectionremainder,...
    'a',0.5,'b',-0.84,'c',-62.6,'d',1.9,...
...
net_iris=trn_izknet_rate2(irisp2,irist2,net,options,-50,50)
...
for i=1:size(irisp,2)
   ...
   result=[result eval_izknet_rate2(net_iris,irisp(:,i))];
...
for i=1:size(iris_untrained_p,2)
   ...
   result_untrained=[result_untrained eval_izknet_rate2(net_iris,iris_untrained_p(:,i))];
