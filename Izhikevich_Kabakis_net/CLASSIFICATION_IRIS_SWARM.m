...
options=izknet_optionset('Number_of_inputs',2,'ms',11,'Std_constant',2.5 ...
    ,'Voltage_sent',100,'Amplifier',100,'SelectionFcn',@selectionremainder,'Sensor_ranges',[0.075,0.8;0.06,0.820]);
...
net_iris=trn_izknet_swarm(irisp2,irist2,net,options,-50,50)
