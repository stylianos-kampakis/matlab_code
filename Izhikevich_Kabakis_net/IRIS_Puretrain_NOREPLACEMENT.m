...
%Sample the dataset
[irisp2 positions]=sample_rand(irisp,100,1,150,1);
...
'Inhibitory_momentum',0.05, ...
'Excitatory_momentum',0.05, ...
...
'Discrepancy_inhibition',0.9,...
'Discrepancy_excitation',1,...
'Discrepancy_inhibition_degradation',0.05,...
'Discrepancy_excitation_degradation',0.05);
...
%net=cluster_sensors(net,irisp',4);
