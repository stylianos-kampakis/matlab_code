...
'Inhibitory','true', ...
'Excitatory','true', ...
'Inhibitory_function','logsig', ...
'Excitatory_function','losgsig', ...
'Inhibitory_momentum',0.2, ...
'Excitatory_momentum',0.2, ...
...
ults=[all_test_results success_untrained];
end
