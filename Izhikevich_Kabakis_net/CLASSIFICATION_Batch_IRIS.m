...
options_for_training=pure_train_optionset('Epochs', 500, ...
'Inhibitory','true', ...
'Excitatory','true', ...
'Inhibitory_function','purelin', ...
'Excitatory_function','purelin', ...
'Inhibitory_momentum',0.01, ...
'Excitatory_momentum',0.01, ...
...
[net_iris,~, training_results,time2]=pure_train_izknet_batch(net,irisp2,irist2,options_for_training);
time=[time time2];
